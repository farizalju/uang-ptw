<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img src="{{ asset('argon/assets/img/brand/green.png') }}" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="{{ url('sumber-pemasukan') }}">
              <i class="ni ni-planet text-blue"></i> Sumber Pemasukan
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{ url('pemasukan') }}">
              <i class="ni ni-pin-3 text-orange"></i> Pemasukan
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{ url('pengeluaran') }}">
              <i class="ni ni-single-02 text-yellow"></i> Pengeluaran
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="{{ url('laporan-keuangan') }}">
              <i class="ni ni-bullet-list-67 text-red"></i> Laporan Keuangan
            </a>
          </li>
